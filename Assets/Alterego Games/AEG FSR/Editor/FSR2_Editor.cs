...
namespace AEG.FSR
{
    ...
    public class FSR2_Editor : Editor
    {
        public override void OnInspectorGUI() {
            ...
            //generateTCMask = EditorGUILayout.Toggle(Styles.tcMaskText, fsrScript.generateTCMask);

            //Experimental! (disabled)
            //if(fsrScript.generateTCMask) {
            //    EditorGUI.indentLevel++;
            //    autoTcThreshold = EditorGUILayout.Slider(Styles.autoTcThresholdText, fsrScript.autoTcThreshold, 0.0f, 1.0f);
            //    autoTcScale = EditorGUILayout.Slider(Styles.autotcScaleText, fsrScript.autoTcScale, 0.0f, 10.0f);
            //    autoTcReactiveScale = EditorGUILayout.Slider(Styles.autoTcReactiveScaleText, fsrScript.autoTcReactiveScale, 0.0f, 5.0f);
            //    autoTcReactiveMax = EditorGUILayout.Slider(Styles.autoTcReactiveMaxText, fsrScript.autoTcReactiveMax, 0.0f, 1.0f);
            //    EditorGUI.indentLevel--;
            //}
